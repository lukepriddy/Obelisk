...
export const VOICES: { name: string; description: string; gender: string; sampleUrl?: string }[] = [
  ...
  { name: 'Iocaste',      description: 'Rich, composed',         gender: 'F' },
  { name: 'Isonoe',       description: 'Calm, precise',          gender: 'F' },
