...
export const PRIVACY_SECTIONS: TermsSection[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'Play records. Which experience you opened, which zones you reached, and when. These are kept so creators can see how their experience is being used. They are not linked to your name or email — players do not sign in.',
